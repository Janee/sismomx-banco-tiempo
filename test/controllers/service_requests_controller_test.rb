...
class ServiceRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_request" do
    assert_difference('ServiceRequest.count') do
      post service_requests_url, params: { service_request: { description: @service_request.description, name: @service_request.name, reference: @service_request.reference, reference: @service_request.reference, reference: @service_request.reference, schedule: @service_request.schedule } }
    end
  ...
  test "should update service_request" do
    patch service_request_url(@service_request), params: { service_request: { description: @service_request.description, name: @service_request.name, reference: @service_request.reference, reference: @service_request.reference, reference: @service_request.reference, schedule: @service_request.schedule } }
